 ...
 <section>
    ...
    <div class="tab-content">
	  ...
	  <div class="tab-pane well" id="control-product-images">
           ...
           <hr class="col-md-12">
		                   ...
		                   <div class="col-md-12 mb-10">
		                     <div class="col-md-4"> <img class="img-thumbnail" style="width:100px;height:100px;" src=""></div>
		                      
		                      <div class="col-md-8">
		                      <p><b>تصویر 2</b></p>
		                         {{ Form::File('image2', ['class'=>'form-control mt-20'] ) }}
		                      </div>
		                   ...
		                   <div class="col-md-12 mb-10">
		                     <div class="col-md-4"> <img class="img-thumbnail" style="width:100px;height:100px;" src=""></div>
		                      ...
		                      <div class="col-md-8">
		                      <p><b>تصویر 3</b></p>
		                         {{ Form::File('image3', ['class'=>'form-control mt-20'] ) }}
		                      </div>
		                   ...
		                   <div class="col-md-12 mb-10">
		                     <div class="col-md-4"> <img class="img-thumbnail" style="width:100px;height:100px;" src=""></div>
		                      ...
		                      <div class="col-md-8">
		                      <p><b>تصویر 4</b></p>
		                         {{ Form::File('image4', ['class'=>'form-control mt-20'] ) }}
		                      </div>
      ...
      <div class="tab-pane well active" id="control-product-details">
                   ...
                   <select name="seller" class="form-control mb-10" >
                  ...
                  {{ Form::label('status' , 'وضعیت') }}
	 			  <select name="status" class="form-control">
                      <option value=1 >ممکن</option>
                      <option value=0 >غیر ممکن</option>
                   </select>
