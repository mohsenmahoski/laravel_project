        ...
        <div class="navbar-header">
            ...
            <a href="http://www.creative-tim.com">
                <div class="logo-container">
                    <div class="logo">
                        <img src="{{asset('images/theme/logo.png')}}" alt="Creative Tim Logo" rel="tooltip" title="<b>Material Kit</b> was Designed & Coded with care by the staff from <b>Creative Tim</b>" data-placement="bottom" data-html="true">
                    </div>
                    <div class="brand">
                        Creative Tim
                    </div>
...
<div class="wrapper">
    <div class="header header-filter" style="background-image: url({{ asset('/images/theme/bg2.jpeg') }});">
        <div class="container">
            <div class="row">
    ...
    <div class="main main-raised">
            ...
            <div class="container tim-container">
                ...
                <div id="images">
                    ...
                    <div class="row">
                        <div class="col-sm-2">
                            <h4>Rounded Image</h4>
                            <img src="{{ asset('/images/theme/avatar.jpg') }}" alt="Rounded Image" class="img-rounded img-responsive">
                        </div>
                        <div class="col-sm-2 col-sm-offset-1">
                            <h4>Circle Image</h4>
                            <img src="{{ asset('/images/theme/avatar.jpg') }}" alt="Circle Image" class="img-circle img-responsive">
                        </div>
                        <div class="col-sm-2 col-sm-offset-1">
                            <h4>Rounded Raised</h4>
                            <img src="{{ asset('/images/theme/avatar.jpg') }}" alt="Raised Image" class="img-rounded img-responsive img-raised">
                        </div>

                        <div class="col-sm-2 col-sm-offset-1">
                            <h4>Circle Raised</h4>
                            <img src="{{ asset('/images/theme/avatar.jpg') }}" alt="Thumbnail Image" class="img-circle img-raised img-responsive">
                        </div>
                    </div>
                    <div class="row">
        ...
        <div class="section section-full-screen section-signup" style="background-image: url('{{asset('/images/theme/city.jpg')}}'); background-size: cover; background-position: top center; min-height: 700px;">
            <div class="container">
                <div class="row">
                ...
                <div class="row">
                    <div class="col-md-6">
                        <a href="examples/landing-page.html" target="_blank">
                            <img src="{{asset('/images/theme/landing.jpg') }}" alt="Rounded Image" class="img-rounded img-raised img-responsive">
                            <button class="btn  btn-simple btn-primary btn-lg">View Landing Page</button>
                        </a>
                    </div>
                    <div class="col-md-6">
                        <a href="examples/profile-page.html" target="_blank">
                            <img src="{{ asset('/images/theme/profile.jpg') }}" alt="Rounded Image" class="img-rounded img-raised img-responsive">
...
<!--  End Modal -->
    ...
    <!--   Core JS Files   -->
    <script src="{{ asset('/js/theme/jquery.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/js/theme/bootstrap.min.js') }}" type="text/javascript"></script>
    <script src="{{ asset('/js/theme/material.min.js') }}"></script>

    <!--  Plugin for the Sliders, full documentation here: http://refreshless.com/nouislider/ -->
    <script src="{{ asset('/js/theme/nouislider.min.js') }}" type="text/javascript"></script>

    <!--  Plugin for the Datepicker, full documentation here: http://www.eyecon.ro/bootstrap-datepicker/ -->
    <script src="{{ asset('/js/theme/bootstrap-datepicker.js') }}" type="text/javascript"></script>

    <!-- Control Center for Material Kit: activating the ripples, parallax effects, scripts from the example pages etc -->
    <script src="{{ asset('/js/theme/material-kit.js') }}" type="text/javascript"></script>
